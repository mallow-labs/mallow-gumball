...
import { Serializer, bytes, i64, publicKey as publicKeySerializer, string, struct } from '@metaplex-foundation/umi/serializers';
...
export type AllowListProofAccountDataArgs = { timestamp: number | bigint;  };
  ...
  export function getAllowListProofAccountDataSerializer(): Serializer<AllowListProofAccountDataArgs, AllowListProofAccountData> {
  return struct<AllowListProofAccountData>([['timestamp', i64()]], { description: 'AllowListProofAccountData' }) as Serializer<AllowListProofAccountDataArgs, AllowListProofAccountData>;
}


export function deserializeAllowListProof(rawAccount: RpcAccount): AllowListProof {
  return deserializeAccount(rawAccount, getAllowListProofAccountDataSerializer());
}
...
export async function safeFetchAllowListProof(
  ...
  return maybeAccount.exists
    ? deserializeAllowListProof(maybeAccount)
    : null;
}
...
export async function safeFetchAllAllowListProof(
  ...
  return maybeAccounts
    ...
    .map((maybeAccount) => deserializeAllowListProof(maybeAccount as RpcAccount));
}

export function getAllowListProofGpaBuilder(context: Pick<Context, 'rpc' | 'programs'>) {
  ...
  return gpaBuilder(context, programId)
    ...
    .deserializeUsing<AllowListProof>((account) => deserializeAllowListProof(account))      .whereSize(8)
    ;
}
