...
import { Serializer, publicKey as publicKeySerializer, string, struct, u16, u8 } from '@metaplex-foundation/umi/serializers';
...
export type MintCounterAccountDataArgs = MintCounterAccountData;
  ...
  export function getMintCounterAccountDataSerializer(): Serializer<MintCounterAccountDataArgs, MintCounterAccountData> {
  return struct<MintCounterAccountData>([['count', u16()]], { description: 'MintCounterAccountData' }) as Serializer<MintCounterAccountDataArgs, MintCounterAccountData>;
}
...
export async function safeFetchMintCounter(
  ...
  return maybeAccount.exists
    ? deserializeMintCounter(maybeAccount)
    : null;
}
...
export function getMintCounterGpaBuilder(context: Pick<Context, 'rpc' | 'programs'>) {
  ...
  return gpaBuilder(context, programId)
    ...
    .deserializeUsing<MintCounter>((account) => deserializeMintCounter(account))      .whereSize(2)
    ;
}
