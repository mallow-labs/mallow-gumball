...
import { Serializer, bool, publicKey as publicKeySerializer, struct, u16, u8 } from '@metaplex-foundation/umi/serializers';
...
export function getBuyBackConfigSerializer(): Serializer<BuyBackConfigArgs, BuyBackConfig> {
  return struct<BuyBackConfig>([['enabled', bool()], ['toGumballMachine', bool()], ['oracleSigner', publicKeySerializer()], ['valuePct', u8()], ['marketplaceFeeBps', u16()], ['cutoffPct', u8()]], { description: 'BuyBackConfig' }) as Serializer<BuyBackConfigArgs, BuyBackConfig>;
}
