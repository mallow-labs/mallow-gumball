...
import { Serializer, struct, u16, u8 } from '@metaplex-foundation/umi/serializers';
...
export function getMintLimitSerializer(): Serializer<MintLimitArgs, MintLimit> {
  return struct<MintLimit>([['id', u8()], ['limit', u16()]], { description: 'MintLimit' }) as Serializer<MintLimitArgs, MintLimit>;
}
