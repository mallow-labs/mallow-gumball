...
import { Serializer, array, bytes, struct, u16, u32, u64, u8 } from '@metaplex-foundation/umi/serializers';
...
export function getCnftArgsSerializer(): Serializer<CnftArgsArgs, CnftArgs> {
  return struct<CnftArgs>([['root', bytes({ size: 32 })], ['metaHash', bytes({ size: 32 })], ['sellerFeeBasisPoints', u16()], ['creators', array(getCnftCreatorSerializer())], ['nonce', u64()], ['index', u32()], ['version', u8()]], { description: 'CnftArgs' }) as Serializer<CnftArgsArgs, CnftArgs>;
}
