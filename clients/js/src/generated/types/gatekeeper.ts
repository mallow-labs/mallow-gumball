...
export function getGatekeeperSerializer(): Serializer<GatekeeperArgs, Gatekeeper> {
  return struct<Gatekeeper>([['gatekeeperNetwork', publicKeySerializer()], ['expireOnUse', bool()]], { description: 'Gatekeeper' }) as Serializer<GatekeeperArgs, Gatekeeper>;
}
