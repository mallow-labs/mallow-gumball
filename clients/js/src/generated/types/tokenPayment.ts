...
export function getTokenPaymentSerializer(): Serializer<TokenPaymentArgs, TokenPayment> {
  return struct<TokenPayment>([['amount', u64()], ['mint', publicKeySerializer()]], { description: 'TokenPayment' }) as Serializer<TokenPaymentArgs, TokenPayment>;
}
