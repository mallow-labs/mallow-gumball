...
import { Serializer, bool, struct, u64 } from '@metaplex-foundation/umi/serializers';
...
export function getBotTaxSerializer(): Serializer<BotTaxArgs, BotTax> {
  return struct<BotTax>([['lamports', mapAmountSerializer(u64(), 'SOL', 9)], ['lastInstruction', bool()]], { description: 'BotTax' }) as Serializer<BotTaxArgs, BotTax>;
}
