...
export function getThirdPartySignerSerializer(): Serializer<ThirdPartySignerArgs, ThirdPartySigner> {
  return struct<ThirdPartySigner>([['signerKey', publicKeySerializer()]], { description: 'ThirdPartySigner' }) as Serializer<ThirdPartySignerArgs, ThirdPartySigner>;
}
