...
export type RequestAddNftInstructionDataArgs = {  };
  ...
  export function getRequestAddNftInstructionDataSerializer(): Serializer<RequestAddNftInstructionDataArgs, RequestAddNftInstructionData> {
  return mapSerializer<RequestAddNftInstructionDataArgs, any, RequestAddNftInstructionData>(struct<RequestAddNftInstructionData>([['discriminator', bytes({ size: 8 })]], { description: 'RequestAddNftInstructionData' }), (value) => ({ ...value, discriminator: new Uint8Array([144, 146, 226, 91, 44, 123, 85, 105]) }) ) as Serializer<RequestAddNftInstructionDataArgs, RequestAddNftInstructionData>;
}
...
export function requestAddNft(
  ...
  const resolvedAccounts = {
          ...
          sellerTokenRecord: { index: 12, isWritable: true as boolean, value: input.sellerTokenRecord ?? null },
          authRules: { index: 13, isWritable: false as boolean, value: input.authRules ?? null },
          instructions: { index: 14, isWritable: false as boolean, value: input.instructions ?? null },
          authRulesProgram: { index: 15, isWritable: false as boolean, value: input.authRulesProgram ?? null },
