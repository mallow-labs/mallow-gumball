...
export type RemoveTokensInstructionAccounts = {
  ...
  // Data.
  export type RemoveTokensInstructionData = { discriminator: Uint8Array; indices: Uint8Array; amount: bigint;  };

export type RemoveTokensInstructionDataArgs = { indices: Uint8Array; amount: number | bigint;  };


  export function getRemoveTokensInstructionDataSerializer(): Serializer<RemoveTokensInstructionDataArgs, RemoveTokensInstructionData> {
  return mapSerializer<RemoveTokensInstructionDataArgs, any, RemoveTokensInstructionData>(struct<RemoveTokensInstructionData>([['discriminator', bytes({ size: 8 })], ['indices', bytes({ size: u32() })], ['amount', u64()]], { description: 'RemoveTokensInstructionData' }), (value) => ({ ...value, discriminator: new Uint8Array([44, 175, 119, 21, 25, 7, 44, 126]) }) ) as Serializer<RemoveTokensInstructionDataArgs, RemoveTokensInstructionData>;
}
...
resolvedAccounts.rent.isWritable = false
  ...
  // Data.
      const data = getRemoveTokensInstructionDataSerializer().serialize(resolvedArgs as RemoveTokensInstructionDataArgs);
