...
export type RemoveCnftInstructionAccounts = {
  ...
  // Data.
  export type RemoveCnftInstructionData = { discriminator: Uint8Array; index: number; args: CnftArgs;  };

export type RemoveCnftInstructionDataArgs = { index: number; args: CnftArgsArgs;  };


  export function getRemoveCnftInstructionDataSerializer(): Serializer<RemoveCnftInstructionDataArgs, RemoveCnftInstructionData> {
  return mapSerializer<RemoveCnftInstructionDataArgs, any, RemoveCnftInstructionData>(struct<RemoveCnftInstructionData>([['discriminator', bytes({ size: 8 })], ['index', u32()], ['args', getCnftArgsSerializer()]], { description: 'RemoveCnftInstructionData' }), (value) => ({ ...value, discriminator: new Uint8Array([24, 204, 40, 184, 195, 73, 136, 210]) }) ) as Serializer<RemoveCnftInstructionDataArgs, RemoveCnftInstructionData>;
}
...
resolvedAccounts.systemProgram.isWritable = false
  ...
  // Data.
      const data = getRemoveCnftInstructionDataSerializer().serialize(resolvedArgs as RemoveCnftInstructionDataArgs);
