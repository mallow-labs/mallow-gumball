...
export type CancelAddCnftRequestInstructionAccounts = {
  ...
  // Data.
  export type CancelAddCnftRequestInstructionData = { discriminator: Uint8Array; args: CnftArgs;  };

export type CancelAddCnftRequestInstructionDataArgs = { args: CnftArgsArgs;  };


  export function getCancelAddCnftRequestInstructionDataSerializer(): Serializer<CancelAddCnftRequestInstructionDataArgs, CancelAddCnftRequestInstructionData> {
  return mapSerializer<CancelAddCnftRequestInstructionDataArgs, any, CancelAddCnftRequestInstructionData>(struct<CancelAddCnftRequestInstructionData>([['discriminator', bytes({ size: 8 })], ['args', getCnftArgsSerializer()]], { description: 'CancelAddCnftRequestInstructionData' }), (value) => ({ ...value, discriminator: new Uint8Array([80, 132, 87, 37, 80, 216, 231, 4]) }) ) as Serializer<CancelAddCnftRequestInstructionDataArgs, CancelAddCnftRequestInstructionData>;
}
  ...
  // Args.
      export type CancelAddCnftRequestInstructionArgs =           CancelAddCnftRequestInstructionDataArgs
      ;
  
// Instruction.
export function cancelAddCnftRequest(
  context: Pick<Context, "eddsa" | "identity" | "programs">,
                        input: CancelAddCnftRequestInstructionAccounts & CancelAddCnftRequestInstructionArgs,
      ): TransactionBuilder {
  // Program ID.
  ...
  const resolvedAccounts = {
          ...
          asset: { index: 4, isWritable: false as boolean, value: input.asset ?? null },
...
resolvedAccounts.systemProgram.isWritable = false
  ...
  // Data.
      const data = getCancelAddCnftRequestInstructionDataSerializer().serialize(resolvedArgs as CancelAddCnftRequestInstructionDataArgs);
