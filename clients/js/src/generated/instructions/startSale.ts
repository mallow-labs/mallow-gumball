...
export type StartSaleInstructionDataArgs = {  };
  ...
  export function getStartSaleInstructionDataSerializer(): Serializer<StartSaleInstructionDataArgs, StartSaleInstructionData> {
  return mapSerializer<StartSaleInstructionDataArgs, any, StartSaleInstructionData>(struct<StartSaleInstructionData>([['discriminator', bytes({ size: 8 })]], { description: 'StartSaleInstructionData' }), (value) => ({ ...value, discriminator: new Uint8Array([130, 69, 235, 113, 173, 219, 48, 228]) }) ) as Serializer<StartSaleInstructionDataArgs, StartSaleInstructionData>;
}
