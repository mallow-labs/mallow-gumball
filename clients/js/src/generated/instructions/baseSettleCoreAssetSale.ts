...
export type BaseSettleCoreAssetSaleInstructionAccounts = {
  ...
  // Data.
  export type BaseSettleCoreAssetSaleInstructionData = { discriminator: Uint8Array; index: number;  };

export type BaseSettleCoreAssetSaleInstructionDataArgs = { index: number;  };


  export function getBaseSettleCoreAssetSaleInstructionDataSerializer(): Serializer<BaseSettleCoreAssetSaleInstructionDataArgs, BaseSettleCoreAssetSaleInstructionData> {
  return mapSerializer<BaseSettleCoreAssetSaleInstructionDataArgs, any, BaseSettleCoreAssetSaleInstructionData>(struct<BaseSettleCoreAssetSaleInstructionData>([['discriminator', bytes({ size: 8 })], ['index', u32()]], { description: 'BaseSettleCoreAssetSaleInstructionData' }), (value) => ({ ...value, discriminator: new Uint8Array([78, 55, 252, 82, 233, 15, 98, 51]) }) ) as Serializer<BaseSettleCoreAssetSaleInstructionDataArgs, BaseSettleCoreAssetSaleInstructionData>;
}
  ...
  // Args.
      export type BaseSettleCoreAssetSaleInstructionArgs =           BaseSettleCoreAssetSaleInstructionDataArgs
      ;
  
// Instruction.
export function baseSettleCoreAssetSale(
  context: Pick<Context, "eddsa" | "identity" | "payer" | "programs">,
                        input: BaseSettleCoreAssetSaleInstructionAccounts & BaseSettleCoreAssetSaleInstructionArgs,
      ): TransactionBuilder {
  // Program ID.
  ...
  const resolvedAccounts = {
          ...
          asset: { index: 17, isWritable: true as boolean, value: input.asset ?? null },
          collection: { index: 18, isWritable: true as boolean, value: input.collection ?? null },
          mplCoreProgram: { index: 19, isWritable: false as boolean, value: input.mplCoreProgram ?? null },
...
resolvedAccounts.mplCoreProgram.isWritable = false
  ...
  // Data.
      const data = getBaseSettleCoreAssetSaleInstructionDataSerializer().serialize(resolvedArgs as BaseSettleCoreAssetSaleInstructionDataArgs);
