 ...
 */
  ...
  // Data.
  export type CancelAddNftRequestInstructionData = { discriminator: Uint8Array;  };

export type CancelAddNftRequestInstructionDataArgs = {  };


  export function getCancelAddNftRequestInstructionDataSerializer(): Serializer<CancelAddNftRequestInstructionDataArgs, CancelAddNftRequestInstructionData> {
  return mapSerializer<CancelAddNftRequestInstructionDataArgs, any, CancelAddNftRequestInstructionData>(struct<CancelAddNftRequestInstructionData>([['discriminator', bytes({ size: 8 })]], { description: 'CancelAddNftRequestInstructionData' }), (value) => ({ ...value, discriminator: new Uint8Array([34, 8, 56, 112, 4, 65, 153, 137]) }) ) as Serializer<CancelAddNftRequestInstructionDataArgs, CancelAddNftRequestInstructionData>;
}
...
export function cancelAddNftRequest(
  ...
  const resolvedAccounts = {
          ...
          sellerTokenRecord: { index: 14, isWritable: true as boolean, value: input.sellerTokenRecord ?? null },
          authRules: { index: 15, isWritable: false as boolean, value: input.authRules ?? null },
          instructions: { index: 16, isWritable: false as boolean, value: input.instructions ?? null },
          authRulesProgram: { index: 17, isWritable: false as boolean, value: input.authRulesProgram ?? null },
      } satisfies ResolvedAccountsWithIndices;

  
    // Default values.
  if (!resolvedAccounts.addItemRequest.value) {
        resolvedAccounts.addItemRequest.value = findAddItemRequestPda(context, { asset: expectPublicKey(resolvedAccounts.mint.value) });
      }
