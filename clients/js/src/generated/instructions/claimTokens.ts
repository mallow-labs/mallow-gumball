...
export type ClaimTokensInstructionAccounts = {
  ...
  // Data.
  export type ClaimTokensInstructionData = { discriminator: Uint8Array; index: number;  };

export type ClaimTokensInstructionDataArgs = { index: number;  };


  export function getClaimTokensInstructionDataSerializer(): Serializer<ClaimTokensInstructionDataArgs, ClaimTokensInstructionData> {
  return mapSerializer<ClaimTokensInstructionDataArgs, any, ClaimTokensInstructionData>(struct<ClaimTokensInstructionData>([['discriminator', bytes({ size: 8 })], ['index', u32()]], { description: 'ClaimTokensInstructionData' }), (value) => ({ ...value, discriminator: new Uint8Array([108, 216, 210, 231, 0, 212, 42, 64]) }) ) as Serializer<ClaimTokensInstructionDataArgs, ClaimTokensInstructionData>;
}
...
export function claimTokens(
  ...
  const resolvedAccounts = {
          ...
          buyer: { index: 5, isWritable: false as boolean, value: input.buyer ?? null },
          ...
          mint: { index: 10, isWritable: false as boolean, value: input.mint ?? null },
