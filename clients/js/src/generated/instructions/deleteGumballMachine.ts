...
export type DeleteGumballMachineInstructionDataArgs = {  };
  ...
  export function getDeleteGumballMachineInstructionDataSerializer(): Serializer<DeleteGumballMachineInstructionDataArgs, DeleteGumballMachineInstructionData> {
  return mapSerializer<DeleteGumballMachineInstructionDataArgs, any, DeleteGumballMachineInstructionData>(struct<DeleteGumballMachineInstructionData>([['discriminator', bytes({ size: 8 })]], { description: 'DeleteGumballMachineInstructionData' }), (value) => ({ ...value, discriminator: new Uint8Array([183, 18, 70, 156, 148, 109, 161, 34]) }) ) as Serializer<DeleteGumballMachineInstructionDataArgs, DeleteGumballMachineInstructionData>;
}
...
export function deleteGumballMachine(
  ...
  const resolvedAccounts = {
          ...
          mintAuthority: { index: 2, isWritable: true as boolean, value: input.mintAuthority ?? null },
