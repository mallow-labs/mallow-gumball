...
export type RemoveCoreAssetInstructionAccounts = {
  ...
  // Data.
  export type RemoveCoreAssetInstructionData = { discriminator: Uint8Array; index: number;  };

export type RemoveCoreAssetInstructionDataArgs = { index: number;  };


  export function getRemoveCoreAssetInstructionDataSerializer(): Serializer<RemoveCoreAssetInstructionDataArgs, RemoveCoreAssetInstructionData> {
  return mapSerializer<RemoveCoreAssetInstructionDataArgs, any, RemoveCoreAssetInstructionData>(struct<RemoveCoreAssetInstructionData>([['discriminator', bytes({ size: 8 })], ['index', u32()]], { description: 'RemoveCoreAssetInstructionData' }), (value) => ({ ...value, discriminator: new Uint8Array([65, 17, 71, 132, 145, 88, 237, 166]) }) ) as Serializer<RemoveCoreAssetInstructionDataArgs, RemoveCoreAssetInstructionData>;
}
...
resolvedAccounts.systemProgram.isWritable = false
  ...
  // Data.
      const data = getRemoveCoreAssetInstructionDataSerializer().serialize(resolvedArgs as RemoveCoreAssetInstructionDataArgs);
