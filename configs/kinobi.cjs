...
const machineSeed = k.publicKeySeed(
  "machine",
...
const defaultsToJellybeanEventAuthorityPda = () =>
  k.pdaDefault("jellybeanEventAuthority", {
    importFrom: "hooked",
  });
const defaultsToGumballMachineAuthorityPda = (
...
const defaultsToJellybeanMachineAuthorityPda = (
  ...
  k.pdaDefault("jellybeanMachineAuthority", {
    importFrom: "hooked",
    seeds: { jellybeanMachine: k.accountDefault(jellybeanMachine) },
  });
const defaultsToJellybeanUnclaimedPrizesPda = (
  jellybeanMachine = "jellybeanMachine",
  buyer = "buyer"
) =>
  k.pdaDefault("jellybeanUnclaimedPrizes", {
    importFrom: "hooked",
    seeds: {
      jellybeanMachine: k.accountDefault(jellybeanMachine),
      buyer: k.accountDefault(buyer),
    },
  });
...
const defaultsToTokenRecordPda = (
  mint = "mint",
  ...
  k.pdaDefault("tokenRecord", {
    ...
    seeds: {
      ...
      token: k.accountDefault(tokenAccount),
    },
  });
...
const defaultsToJellybeanProgram = () =>
  k.programDefault(
    "mallowJellybean",
...
kinobi.update(
  new k.SetInstructionAccountDefaultValuesVisitor([
    ...
    {
      ...defaultsToJellybeanEventAuthorityPda(),
      account: "jellybeanEventAuthority",
      ignoreIfOptional: true,
    },
    {
      ...defaultsToProgram(),
    ...
    {
      ...defaultsToJellybeanProgram(),
      account: "jellybeanMachineProgram",
      ignoreIfOptional: true,
    },
    {
      ...defaultsToProgram(),
      account: "machineProgram",
      ignoreIfOptional: true,
    },
    {
      ...k.payerDefault(),
    ...
    {
      ...defaultsToJellybeanMachineAuthorityPda(),
      account: "jellybeanMachineAuthorityPda",
      ignoreIfOptional: true,
    },
    {
      ...defaultsToJellybeanUnclaimedPrizesPda(),
...
kinobi.update(
  new k.UpdateInstructionsVisitor({
    ...
    "gumballGuard.draw": {
      ...
      accounts: {
        gumballGuard: {
          defaultsTo: defaultsToGumballGuardPda("gumballMachine"),
        },
        buyer: { defaultsTo: k.identityDefault() },
      },
    },
    "gumballGuard.drawJellybean": {
      ...
      accounts: {
        gumballGuard: {
          defaultsTo: defaultsToGumballGuardPda("jellybeanMachine"),
        },
        buyer: { defaultsTo: k.identityDefault() },
      },
    },
    ...
    "gumballGuard.route": {
      ...
      accounts: {
        gumballGuard: { defaultsTo: defaultsToGumballGuardPda("machine") },
      },
    },
    ...
    "gumballGuard.withdraw": {
      ...
      accounts: {
        authorityPda: {
          defaultsTo: defaultsToGumballMachineAuthorityPda("machine"),
        },
      },
    },
